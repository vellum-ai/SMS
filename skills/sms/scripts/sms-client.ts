/**
 * Outbound send for the `sms` skill's scripts.
 *
...
export async function sendMessage(
  opts: SendOptions,
  /**
   * Test seam, never passed by the CLI. Kept in the same shape as the
   * iMessage plugin's so a future multi-provider registry needs no churn
   * here.
   */
  deps: Pick<ResolveProviderOptions, never> = {},
): Promise<SentChunk[]> {
