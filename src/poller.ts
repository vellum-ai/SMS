 ...
 * ever calls `fetchInbound`. It never sees a Twilio payload or any
 * provider-shaped JSON — adapters normalize before handing a
  ...
  start(): void {
    ...
    if (!this.cursor.since) {
      ...
      this.opts.logger.info(
        ...
        "sms: no stored cursor, polling from now",
      );
    }
