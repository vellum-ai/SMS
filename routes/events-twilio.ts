 ...
 * and the sorted form params, keyed by the account auth token. The
 * `channels/ingress.json` manifest expresses those canonical values through
 * the gateway's generic HMAC verification descriptor. The handler never sees
